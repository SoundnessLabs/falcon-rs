...
// Contract configuration (from environment variables with fallbacks)
export const CONTRACT_ID = import.meta.env.VITE_CONTRACT_ID || 'CCVZDNGKWJPRLOXS4CBOJ2HTYNIW4C3244GG2CAA5V7UIYOMTF355QR7'
...
// To create your own: stellar keys generate demo --network testnet
// Then fund it: curl "https://friendbot.stellar.org?addr=$(stellar keys address demo)"
const DEMO_SECRET = import.meta.env.VITE_STELLAR_SECRET || 'SDLMK4OHNKOXOELJ7LIAOYCPDRPFRLVCXLXX7A7FBYY4TH2CELI5J2E4'
  ...
  try {
    ...
    if (txStatus === 'SUCCESS') {
      ...
      return {
        ...
        explorerUrl: `https://stellar.expert/explorer/${NETWORK === 'mainnet' ? 'public' : 'testnet'}/tx/${txHash}`,
      }
    } else {
      return {
        success: false,
